...
class Game:
    ...
    def show_start_screen(self):
        ...
        pg.mixer.music.play(loops=-1)
        self.screen.fill(GREY)
        self.draw_text(TITLE, WIDTH/2, HEIGHT/7, 48, YELLOW)
        self.draw_text(TEAM,WIDTH/2,HEIGHT/4,22,YELLOW)
        self.draw_text(ADVICE,WIDTH/2,HEIGHT*6/7,40,BLACK)
        self.draw_text("Right & LEFT to move, UP to jump", WIDTH/2, HEIGHT/2, 22, YELLOW)
